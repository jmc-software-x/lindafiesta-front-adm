...
export async function PATCH(
  ...
  try {
    const upstreamResponse = await fetch(`${getBackendApiBaseUrl()}/service-categories/${id}`, {
      method: 'PATCH',
      headers: {
    ...
    return NextResponse.json(
      { ok: false, message: 'No se pudo conectar con backend para actualizar categoria.' },
